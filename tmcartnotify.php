...
?><?php
class plgHikashopTmcartnotify extends JPlugin
{
	public function __construct(&$subject, $config) {
		...
		$plugin = JPluginHelper::getPlugin('hikashop', 'tmcartnotify');
	...
	protected function initCartNotificationScript() {
		...
		$doc->addScript($base.'/plugins/hikashop/tmcartnotify/media/notify.js');
...
';
	...
	protected function initVex() {
		...
		$base = ($app->isAdmin()) ? '..' : JURI::base(true);
		$doc->addScript($base.'/plugins/hikashop/tmcartnotify/media/notify-vex.js');
